...
(function () {
  ...
  var OFFERS = {
    ...
    shiryo: {
      url: 'https://px.a8.net/svt/ejp?a8mat=4B8DGQ+383LAA+5WEE+5YJRM',  // ★キャリナビ転職 承認済み(2026-07-31)・完全無料の伴走型キャリアコーチング・新規面談11,000円・掲載サイト=まい転職アフィ
      fallback: 'https://posiwill.jp/career/',
      label: 'キャリナビ転職（完全無料の伴走型キャリアコーチング）',
